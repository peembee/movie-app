...
export default function About() {
  ...
  const documentTitle = appName.appName + " - About";
  ...
  return (
    <>
      ...
      <Container maxWidth="m">
        <h2 className="aboutPageTitle">What is Lorem Ipsum?</h2>
        ...
        <h2 className="aboutPageTitle">Why do we use it?</h2>
        <p className="aboutPage">
        ...
        <h2 className="aboutPageTitle">Where does it come from?</h2>
        <p className="aboutPage">
